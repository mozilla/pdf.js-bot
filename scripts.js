...
exports.runTests = function(args, callback){
  ...
  console.log((new Date())+': running ./fetch-repo-run-tests', args.pull_url, args.ref_url, args.pull_sha, args.dest_path); 

  //
  // Launch process
  //
  gitProcess = spawn('./fetch-repo-run-tests', [args.pull_url, args.ref_url, args.pull_sha, args.dest_path])
